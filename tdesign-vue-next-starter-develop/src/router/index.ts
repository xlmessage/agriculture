...
const defaultRouterList: Array<RouteRecordRaw> = [
  ...
  {
    path: '/screen/nationwide',
    name: 'screen-nationwide',
    component: () => import('@/pages/screen/nationwide/components/index.vue'),
  },
  {
    path: '/screen/locality',
    name: 'screen-locality',
    component: () => import('@/pages/screen/locality/components/index.vue'),
  },
  {
    path: '/compare/select',
    name: 'compare-select',
    component: () => import('@/pages/screen/compare/components/index.vue'),
  },
];
// 存放固定路由
